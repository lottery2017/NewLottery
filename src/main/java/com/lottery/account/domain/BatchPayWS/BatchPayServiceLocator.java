...
public class BatchPayServiceLocator extends org.apache.axis.client.Service implements BatchPayService {
    ...
    public BatchPayServiceLocator(String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for BatchPayWS
    private String BatchPayWS_address = "https://sandbox.99bill.com/apipay/services/BatchPayWS";
